        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    _b = true;
                    switch (_b) {
                        case !!access.token: return [3 /*break*/, 3];
                        case refresh.expired_at < now: return [3 /*break*/, 4];
                        case access.expired_at < now: return [3 /*break*/, 5];
                        case access.expired_at < now + PRE_REFRESH_PERIOD: return [3 /*break*/, 7];
                    }
                    return [3 /*break*/, 8];
                case 3:
                ...
                case 1:
                    ...
                    if (!tokenUpdater) {
                        tokenUpdater = refreshInstance
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, saveCreds(res.data.data)];
